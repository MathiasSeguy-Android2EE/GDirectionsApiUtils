 ...
 * @goals This class aims to parse a json object like that to shape the smallest data weight:
 * {
 * "routes" : [
 * {
 * "bounds" : {
 ...
 * }
 */
public class LightWeightDirectionsJSONParser extends Converter.Factory {
    /***********************************************************
    *  Attributes
    **********************************************************/
    ...
    **********************************************************/
    ...
    public Converter<ResponseBody, ?> responseBodyConverter(Type type, Annotation[] annotations, Retrofit retrofit) {
        return DirectionsJSONConverter.INSTANCE;
    }

    final static class DirectionsJSONConverter implements Converter<ResponseBody, List<GDirection>> {
        static final DirectionsJSONConverter INSTANCE = new DirectionsJSONConverter();

        @Override
        public List<GDirection> convert(ResponseBody responseBody) throws IOException {
            try {
                return parse(new JSONObject(responseBody.string()));
     ...
     */
    private static List<GDirection> parse(JSONObject jObject) {
     ...
     * -api-with-java
     */
    private static List<GDPoint> decodePoly(String encoded) {
